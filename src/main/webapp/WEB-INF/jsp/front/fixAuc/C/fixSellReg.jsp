				...
				<div class="info_box">
					...
					<div class="m_col_wrap">
						<div class="m_col_left">
							<!-- 테이블03(S) -->
							<form id="frm" name="frm" method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/front/fixCAuc/fixSellRegProc.do" >
...
function fn_addSave(){
	...
	$.ajax({
        ...
        cache: false,
        timeout: 600000,
        url : "${pageContext.request.contextPath}/front/fixCAuc/fixSellRegProc.json",
