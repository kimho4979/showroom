			...
			<div class="sub_conts_in">
				...
				<div class="info_box">
					...
					<div class="m_col_wrap">
						<form id="frm" name="frm" method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/front/fixCAuc/fixAdmSubUptProc.do" >
											...
											<tr>
												...
												<td class="tl">
													...
													<select id="chulCode" name="chulCode">
														<option value="${result.chulCode}" selected="selected">${fn:substring(result.chulCode,0,4)} - ${fn:substring(result.chulCode,4,8)} ( ${result.chulName} )</option>	
													</select>
													</div>
												</td>
											</tr>
