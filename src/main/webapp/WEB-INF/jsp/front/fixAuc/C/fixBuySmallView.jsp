					...
					<div class="table_type_03">
						<table>
							...
							<tbody>
								...
								<tr>
									<th class="tc">상태</th>
									<td class="tc" <c:if test="${result.mokCode ne '1005'}">colspan="1"</c:if>>
									<p class="txt_01">
					...
					<div class="table_type_06 devide_4" id="bid_table" <c:if test="${result.fixState ne '7'}">style="display:none;"</c:if>>
						<ul>
							...
							<li>
								...
								<div class="t_td">
									<p class="txt_01" style="height: 47px; text-align: center; line-height: 47px;">${result.boxCnt}</p>
									<input type="hidden" id="bidBoxCnt" value="${result.boxCnt}"/>
								</div>
							</li>
							<li>
								<div class="t_th">
								...
								<div class="t_td">
									<p class="txt_01" style="height: 47px; text-align: center; line-height: 47px;">${result.sokCnt}</p>
									<input type="hidden" id="bidSokCnt" value="${result.sokCnt}"/>
								</div>
							</li>
							<li>
								<div class="t_th">
...
function getBidBuyInfo(fixDealSeq){
	...
	$.ajax({
        ...
        type : "POST",
        url : "${pageContext.request.contextPath}/front/fixCAuc/getSmallBidBuyInfo.json",
        success : function(data){
           console.log(data);
           var bidBoxCnt = "";
           var bidSokCnt = "";
...
function fn_list(){
	...
	window.location.href = "${pageContext.request.contextPath}/front/fixCAuc/fixBuySmallList.do?jCode="+jCode;
}
