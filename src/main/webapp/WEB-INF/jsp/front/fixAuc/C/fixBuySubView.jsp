			...
			<div class="sub_conts_in">
				...
				<div class="info_box">
					...
					<div class="btn_box mt30">
						<a href="javascript:fn_req('${result.fixSubDealSeq}')" class="btn_type_01">구매요청</a>
...
function fn_req(chulCode, mokCode, mokName, pumCode, pumName, unitPrice){
	window.location.href = "${pageContext.request.contextPath}/front/fixCAuc/reqBuySubReg.do?chulCode="+chulCode+"&mokCode="+mokCode+"&pumCode="+pumCode+"&unitPrice="+unitPrice+"&mokName="+encodeURI(mokName)+"&pumName="+encodeURI(pumName);
}*/

function fn_req(fixSubDealSeq){
	window.location.href = "${pageContext.request.contextPath}/front/fixCAuc/reqBuySubReg.do?fixSubDealSeq="+fixSubDealSeq;
}
