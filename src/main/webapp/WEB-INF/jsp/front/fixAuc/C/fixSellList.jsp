...
function fn_view(fixDealSeq){
	window.location.href = "${pageContext.request.contextPath}/front/fixCAuc/fixSellView.do?fixDealSeq="+fixDealSeq;
}

function fn_reg(){
	window.location.href = "${pageContext.request.contextPath}/front/fixCAuc/fixSellReg.do";
}
...
function fn_more(){
	...
	$.ajax({
        ...
        type : "POST",
        url : "${pageContext.request.contextPath}/front/fixCAuc/fixSellList.json",
						...
						<div class="info_box">
							...
							<div class="sub_tab">
								<ul class="devide_3">
									...
									<li><a href="${pageContext.request.contextPath}/front/fixCAuc/fixSellList.do" class="active">관엽</a></li>
							...
							<!-- 검색조건창(S) -->
							<form id="frm" name="searchFrm" method="post" action="${pageContext.request.contextPath}/front/fixCAuc/fixSellList.do" >
								...
								<table id="fixTable">
									...
									<thead>
										<tr>
											...
											<th style="cursor: pointer;" onclick="fn_order(6);">분수량</th>
												...
												<div class="table_info">
													...
													<ul class="profile_box">
														<li>
															...
															<p class="txt_01">수량 : <fmt:formatNumber value="${result.sokCnt}" pattern="#,###" />분 <fmt:formatNumber value="${result.boxCnt}" pattern="#,###" />상자</p>
															<p class="txt_01">판매구분 : 
																<c:if test="${result.dealType eq 'L'}">
																	최저가
																</c:if>
