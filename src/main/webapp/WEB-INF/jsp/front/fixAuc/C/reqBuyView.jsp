...
function fn_update(reqDealSeq){
	window.location.href = "${pageContext.request.contextPath}/front/fixCAuc/reqBuyUpt.do?reqDealSeq="+reqDealSeq;
}

function fn_delete(reqDealSeq){
	window.location.href = "${pageContext.request.contextPath}/front/fixCAuc/reqBuyDelProc.do?reqDealSeq="+reqDealSeq;
}
