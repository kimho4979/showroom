			...
			<div class="sub_conts_in">
				...
				<div class="info_box">
						...
						<table>
							...
							<tbody>
								<tr>
									...
									<input type="hidden" id="resultPUnit" value="${result.pUnit2}">
								</tr>
								<tr>
					...
					<div class="btn_box mt30">
						...
						<a href="javascript:fn_list();" class="btn_type_01 list">목록</a>
					</div>
					<!-- 버튼박스(E) -->
...
function getBidBuyInfo(fixDealSeq){
	...
	$.ajax({
        ...
        type : "POST",
        url : "${pageContext.request.contextPath}/front/fixCAuc/getBidBuyInfo.json",
        success : function(data){
           console.log(data);
           var bidBoxCnt = "";
           var bidSokCnt = "";
...
function fn_bid(){
	...
	var resultPUnit = $("#resultPUnit").val();
	var code = $("#jCode").prop("value");
...
function fn_list(){
	...
	window.location.href = "${pageContext.request.contextPath}/front/fixCAuc/fixBuyList.do?jCode="+jCode;
}
