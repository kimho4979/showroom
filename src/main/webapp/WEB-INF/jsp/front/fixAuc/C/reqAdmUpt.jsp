				...
				<div class="info_box">
					...
					<div class="m_col_wrap">
						<div class="m_col_left">
							<!-- 테이블03(S) -->
							<form id="frm" name="frm" method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/front/fixCAuc/reqAdmUptProc.do" >
												...
												<td class="tl">
													<div class="sb_data ml10">
														<label class="radio mr10">
															<input type="radio" name="panType" value="03" <c:if test="${result.panType eq '03' || result.panType eq null}">checked="checked"</c:if>>
															<i class="rdo"></i>
															<em class="label-title">선취</em>
														</label>
														<label class="radio mr10">
															<input type="radio" name="panType" value="04" <c:if test="${result.panType eq '04'}">checked="checked"</c:if>>
															<i class="rdo"></i>
							...
							<div class="btn_box mt30">
								...
								<a href="${pageContext.request.contextPath}/front/fixCAuc/reqAdmList.do" class="btn_type_01 list">목록</a>
							</div>
						</div>
				...
				<div class="pop-conts_00">
					...
					<div class="choice_box">
						<div class="popup_search">
							...
							<a href="javascript:getJList();" class="btn_search_03 btn-popup ml10 vb">검색</a>
						</div>
...
function getRecentList(){
	...
	if(jCode != null && jCode != ''){
		$.ajax({
	        ...
	        type : "POST",
	        url : "${pageContext.request.contextPath}/front/fixCAuc/getJRecentList.json",
	        success : function(data){
...
function getJList(){
	...
	$.ajax({
        ...
        type : "POST",
        url : "${pageContext.request.contextPath}/front/fixCAuc/getJList.json",
        success : function(data){
