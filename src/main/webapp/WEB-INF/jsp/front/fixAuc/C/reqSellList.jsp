...
function fn_view(reqDealSeq){
	window.location.href = "${pageContext.request.contextPath}/front/fixCAuc/reqSellView.do?reqDealSeq="+reqDealSeq;
}

function fn_reg(){
	window.location.href = "${pageContext.request.contextPath}/front/fixCAuc/reqSellReg.do";
}
...
function fn_more(){
	...
	$.ajax({
        ...
        type : "POST",
        url : "${pageContext.request.contextPath}/front/fixCAuc/reqSellList.json",
...
function fn_comp(){
	...
	if(checkedArray.length == 0){
		...
		$.ajax({
	        ...
	        type : "POST",
	        url : "${pageContext.request.contextPath}/front/fixCAuc/reqSellComp.json",
	        success : function(data){
						...
						<div class="info_box">
							...
							<div class="sub_tab">
								<ul class="devide_3">
									...
									<li><a href="${pageContext.request.contextPath}/front/fixCAuc/reqSellList.do" class="active">관엽</a></li>
									</c:if>
								</ul>
							</div>
							<!-- 서브탭(E) -->
							...
							<!-- 검색조건창(S) -->
							<form id="frm" name="searchFrm" method="post" action="${pageContext.request.contextPath}/front/fixCAuc/reqSellList.do" >
											...
											<div class="sb_data">
												<div class="sel_type_01 w150">
													<select id="searchFixState" name="searchFixState"> 
														...
														<!--  <option value="4" <c:if test="${paramMap.searchFixState eq '5'}">selected="selected"</c:if>>미체결</option> -->
													</select>
