					...
					<div class="table_type_03">
						<table>
							...
							<tbody>
								...
								<c:if test="${result.fixState eq '5'}">
								<tr>
									<th class="tc">미체결 사유</th>
									<td class="tc" colspan="3"><p class="txt_01">${result.gtext}</p></td>
								</tr>
								</c:if>
							</tbody>
						</table>
			...
			<div class="pop-container">
				...
				<div class="pop-conts_00">
					...
					<div class="choice_box">
						...
						<textarea wrap="physical" id="smsText2" style="width:100%;height:100px;border: 1px solid;font-size: 12px;padding: 2px 2px 2px 2px;">${result.chulName} ${result.mokName}[${result.pumName}] ${result.boxCnt}상자(${result.sokCnt}분) 
						</textarea>
...
function fn_update(reqDealSeq){
	window.location.href = "${pageContext.request.contextPath}/front/fixCAuc/reqAdmUpt.do?reqDealSeq="+reqDealSeq;
}

function fn_delete(reqDealSeq){
	window.location.href = "${pageContext.request.contextPath}/front/fixCAuc/reqAdmDelProc.do?reqDealSeq="+reqDealSeq;
}
