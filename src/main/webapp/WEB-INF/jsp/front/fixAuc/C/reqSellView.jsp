			...
			<div class="sub_conts_in">
				...
				<div class="info_box">
					...
					<div class="btn_box mt30">
						...
						<a href="${pageContext.request.contextPath}/front/fixCAuc/reqSellList.do" class="btn_type_01 list">목록</a>
...
function fn_ban(reqDealSeq){
	...
	$.ajax({
        ...
        type : "POST",
        url : "${pageContext.request.contextPath}/front/fixCAuc/reqSellBan.json",
        success : function(data){
             alert("정삭적으로 미체결처리되었습니다.");
             window.location.href = "${pageContext.request.contextPath}/front/fixCAuc/reqSellList.do";
        }
    });
