				...
				<div class="info_box">
					...
					<div class="m_col_wrap">
						<div class="m_col_left">
							<!-- 테이블03(S) -->
							<form id="frm" name="frm" method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/front/fixCAuc/reqBuyRegProc.do" >
										...
										<tbody>
											...
											<tr>
												...
												<td class="tl">
													...
													<input type="hidden" id="pUnit2" name="pUnit2" value=""/>
											...
											<tr>
												...
												<td class="tl">
													<div class="ip_type_01 w100">
														<input type="number" class="tr" id="unitPrice" value="<c:out value="${paramMap.unitPrice}"/>" name="unitPrice" maxlength="10" oninput="maxLengthCheck(this)">
												...
												<td class="tl">
													<div class="sb_data ml10">
														<label class="radio mr10">
															<input type="radio" name="panType" value="03" checked="checked">
															<i class="rdo"></i>
															<em class="label-title">선취</em>
														</label>
														<label class="radio mr10">
															<input type="radio" name="panType" value="04">
															<i class="rdo"></i>
...
function getRecentCList(){
	...
	$.ajax({
        ...
        type : "POST",
        url : "${pageContext.request.contextPath}/front/fixCAuc/getCRecentList.json",
        success : function(data){
           console.log("최근정보:",data);
           var html = "";
           var recentList = data.recentList;
