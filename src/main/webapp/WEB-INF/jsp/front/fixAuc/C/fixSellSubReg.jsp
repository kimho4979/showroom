			...
			<div class="sub_conts_in">
				...
				<div class="info_box">
					...
					<div class="m_col_wrap">
						<form id="frm" name="frm" method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/front/fixCAuc/fixSellSubRegProc.do" >
													...
													<select id="chulCode" name="chulCode">
														<c:forEach items="${floList}" var="floVO" varStatus="status">
															<c:if test="${floVO.bunChk eq 'C'}">
																<option value="${floVO.code}" <c:if test="${cFloLoginVO.chulCd eq  floVO.code}">selected="selected"</c:if>>${fn:substring(floVO.code,0,4)} - ${fn:substring(floVO.code,4,8)} ( ${floVO.name} )</option>
															</c:if>
														</c:forEach>	
													</select>
													</div>
											...
											<tr>
												...
												<td class="tl">
													<div class="ip_type_01 w50p">
														<input type="text" class="tl" id="pumNameCustom" name="pumNameCustom" maxlength="500" >
											...
											<tr>
												...
												<td class="tl">
													<div class="ip_type_01 w100">
														<input type="number" class="tr" id="unitSok" name="unitSok" maxlength="4" oninput="maxLengthCheck(this)">
						...
						<div class="m_col_right">
							<div class="info_box_02">
								...
								<div class="t_area mt10" style="height:calc(100% - 40px);">
									<textarea name="itemText" wrap="physical"></textarea>
								</div>
							</div>
						</div>
						</form>
