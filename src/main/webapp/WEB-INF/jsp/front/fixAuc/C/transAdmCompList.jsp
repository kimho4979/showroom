...
function fn_save(){
	...
	$.ajax({
        ...
        type : "POST",
        url : "${pageContext.request.contextPath}/front/fixCAuc/transAdmCompListUpdate.json",
...
function fn_ha(){
	...
	var url = contextPath + "/front/fixCAuc/transAdmCompChulListPrint.do?chulDate="+chulDate; 
...
function fn_board(){
	var chulDate = $("#chulDate").val();
	var url = contextPath + "/front/fixCAuc/transAdmCompDomeListPrint.do?chulDate="+chulDate; 
