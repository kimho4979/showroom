...
function fn_update(reqDealSeq){
	window.location.href = "${pageContext.request.contextPath}/front/fixNAuc/reqAdmUpt.do?reqDealSeq="+reqDealSeq;
}

function fn_delete(reqDealSeq){
	window.location.href = "${pageContext.request.contextPath}/front/fixNAuc/reqAdmDelProc.do?reqDealSeq="+reqDealSeq;
}
