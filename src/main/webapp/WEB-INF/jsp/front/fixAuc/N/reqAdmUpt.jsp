				...
				<div class="info_box">
					...
					<div class="m_col_wrap">
						<div class="m_col_left">
							<!-- 테이블03(S) -->
							<form id="frm" name="frm" method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/front/fixNAuc/reqAdmUptProc.do" >
														...
														<select id="boxCode" name="boxCode">
															...
															<c:forEach items="${boxList}" var="boxRow">
																...
																<c:if test="${result.boxCode != null}">
																	...
																	<c:if test="${boxRow.boxCode eq result.boxCode}"><option value="${boxRow.boxCode}" selected="selected">[ ${boxRow.boxCode} ] ${boxRow.boxName}</option></c:if>
																	<c:if test="${boxRow.boxCode ne result.boxCode}"><option value="${boxRow.boxCode}">[ ${boxRow.boxCode} ] ${boxRow.boxName}</option></c:if>
