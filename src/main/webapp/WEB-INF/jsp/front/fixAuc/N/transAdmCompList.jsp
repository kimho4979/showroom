...
function fn_save(){
	...
	$.ajax({
        ...
        type : "POST",
        url : "${pageContext.request.contextPath}/front/fixNAuc/transAdmCompListUpdate.json",
...
function fn_ha(){
	...
	var url = contextPath + "/front/fixNAuc/transAdmCompChulListPrint.do?chulDate="+chulDate; 
...
function fn_board(){
	var chulDate = $("#chulDate").val();
	var url = contextPath + "/front/fixNAuc/transAdmCompDomeListPrint.do?chulDate="+chulDate; 
