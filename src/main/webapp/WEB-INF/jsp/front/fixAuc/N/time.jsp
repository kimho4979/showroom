...
function fn_timeSave(){
	...
	paramList.push({bunChk:"N",timeType:"1",strTime:$(".strTime1").val(),endTime:$(".endTime1").val()});
	paramList.push({bunChk:"N",timeType:"2",strTime:$(".strTime2").val(),endTime:$(".endTime2").val()});
	paramList.push({bunChk:"N",timeType:"3",strTime:$(".strTime3").val(),endTime:$(".endTime3").val()});
	console.log(paramList);
	$.ajax({
		data: {paramList : JSON.stringify(paramList)
		},
        type : "POST",
        url : "${pageContext.request.contextPath}/front/fixNAuc/updateTime.json",
        success : function(data){
            if(data.status == "sucess"){
            	alert("저장되었습니다.");
            	location.href = "${pageContext.request.contextPath}/front/fixNAuc/time.do";
            }else{
						...
						<div class="info_box">
							...
							<div class="sub_tab">
								<ul class="devide_3">
									...
									<li><a href="${pageContext.request.contextPath}/front/fixNAuc/time.do" class="active">절화</a></li>
									</c:if>
									...
									<li><a href="${pageContext.request.contextPath}/front/fixCAuc/time.do">관엽</a></li>
									</c:if>
								</ul>
							</div>
							<!-- 서브탭02(E) -->
