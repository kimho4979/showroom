...
function fn_view(fixDealSeq){
	...
	window.location.href = "${pageContext.request.contextPath}/front/fixNAuc/fixBuySmallView.do?fixDealSeq="+fixDealSeq+"&jCode="+jCode;
}

/* function fn_reg(){
	window.location.href = "${pageContext.request.contextPath}/front/fixNAuc/fixBuySmallReg.do";
} */
...
function fn_more(){
	...
	$.ajax({
        ...
        type : "POST",
        url : "${pageContext.request.contextPath}/front/fixNAuc/fixBuySmallList.json",
...
function fn_bid(fixDealSeq, bidBoxCnt, bidSokCnt, bidUnitPrice ){
	...
	$.ajax({
        ...
        type : "POST",
        url : "${pageContext.request.contextPath}/front/fixNAuc/fixBuySmallBid.json",
        success : function(data){
           if(data.result == 1){
        	   alert("정상적으로 입찰되었습니다");
						...
						<div class="info_box">
							...
							<div class="sub_tab">
								<ul class="devide_3">
									...
									<li><a href="${pageContext.request.contextPath}/front/fixNAuc/fixBuySmallList.do" class="active">절화</a></li>
									</c:if>
							...
							<!-- 검색조건창(S) -->
							<form id="frm" name="searchFrm" method="post" action="${pageContext.request.contextPath}/front/fixNAuc/fixBuySmallList.do" >
							...
							<div class="table_type_04 mt5 overflow_a">
								<table>
									...
									<colgroup>
										...
										<col style="width:115.54px;">
										<col style="width:90.27px;">
										<col style="width:90.27px;">
										<col style="width:90.27px;">
										<col style="width:90.27px;">
										<col style="width:90.27px;">
										<col style="width:105.27px;">
										<col style="width:60px;">
										<col style="width:105.54px;">
										<col style="width:90.27px;">
									</colgroup>
									<thead>
										<tr>
