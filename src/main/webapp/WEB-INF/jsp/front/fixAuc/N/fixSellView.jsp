...
function fn_update(fixDealSeq){
	window.location.href = "${pageContext.request.contextPath}/front/fixNAuc/fixSellUpt.do?fixDealSeq="+fixDealSeq;
}

function fn_delete(fixDealSeq){
	window.location.href = "${pageContext.request.contextPath}/front/fixNAuc/fixSellDelProc.do?fixDealSeq="+fixDealSeq;
}
