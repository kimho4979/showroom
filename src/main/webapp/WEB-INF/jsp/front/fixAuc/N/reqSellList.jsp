				...
				<div class="tab_content pdt0">
					...
					<div class="ti_01">
						<div class="info_box">
							...
							<!-- 검색조건창(S) -->
							<form id="frm" name="searchFrm" method="post" action="${pageContext.request.contextPath}/front/fixNAuc/reqSellList.do" >
								...
								<table id="fixTable">
									...
									<thead>
										<tr>
											...
											<th style="cursor: pointer;" onclick="fn_order(10);">속수량</th>
