...
function fn_view(fixDealSeq){
	window.location.href = "${pageContext.request.contextPath}/front/fixNAuc/fixAdmView.do?fixDealSeq="+fixDealSeq;
}
	...
	if(checkedArray.length == 0){
		...
		$.ajax({
	        ...
	        success : function(data){
	             ...
	             location.href = "${pageContext.request.contextPath}/front/fixNAuc/fixAdmList.do?history=true";
	             /* 정렬 유지 수정 1 (E) */
	        }
	    });
	}
						...
						<div class="info_box">
							...
							<div class="sub_tab">
								<ul class="devide_3">
									...
									<li><a href="${pageContext.request.contextPath}/front/fixNAuc/fixAdmList.do" class="active">절화</a></li>
									</c:if>
							...
							<form id="frm" name="searchFrm" method="get" action="${pageContext.request.contextPath}/front/fixNAuc/fixAdmList.do" >
							<!-- 정렬 유지 수정 5 (E) -->
								...
								<table id="fixTable">
									...
									<thead>
										<tr>
											...
											<th style="cursor: pointer;" onclick="fn_order(12);">판매단가</th>
											<th>경매일자</th>
									...
									<tbody id="resultWebList">
										<c:forEach items="${resultList}" var="result" varStatus="status">
											<tr id="fixTr${result.fixDealSeq}">
												...
												<td class="tc" style="cursor:pointer" onclick="fn_view('${result.fixDealSeq}');"><p class="txt_01">${result.pumName}</p><c:if test="${result.twinCnt ne '0'}">/${result.twinCnt}</c:if></td>
...
<!-- 요청관리 버튼(7개)(S) -->
<div class="btn-tab-new right d7">
	<ul>
		<li class="btn-chk-icon agree"><a href="javascript:fn_apply();"><i><img src="/yfmc/img/btn-new-01.png" alt="승인"></i><p>승인</p></a></li><!--승인-->				
		<li class="btn-chk-icon a-cancel"><a href="javascript:fn_appCancel();"><i><img src="/yfmc/img/btn-new-02.png" alt="승인취소"></i><p>승인취소</p></a></li><!--승인취소-->				
		<li class="btn-chk-icon complete"><a href="javascript:fn_comp();"><i><img src="/yfmc/img/btn-new-03.png" alt="완료"></i><p>완료</p></a></li><!--완료-->				
