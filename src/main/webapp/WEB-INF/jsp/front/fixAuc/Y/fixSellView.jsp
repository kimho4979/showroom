...
function fn_update(fixDealSeq){
	window.location.href = "${pageContext.request.contextPath}/front/fixYAuc/fixSellUpt.do?fixDealSeq="+fixDealSeq;
}

function fn_delete(fixDealSeq){
	window.location.href = "${pageContext.request.contextPath}/front/fixYAuc/fixSellDelProc.do?fixDealSeq="+fixDealSeq;
}
