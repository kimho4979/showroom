					...
					<div class="table_type_03">
						<table>
							...
							<tbody>
								...
								<tr>
									<th class="tc">상태</th>
									<td class="tc" <c:if test="${result.mokCode ne '1005'}">colspan="3"</c:if>>
									<p class="txt_01">
...
function getBidBuyInfo(fixDealSeq){
	...
	$.ajax({
        ...
        type : "POST",
        url : "${pageContext.request.contextPath}/front/fixYAuc/getSmallBidBuyInfo.json",
        success : function(data){
           console.log(data);
           var bidBoxCnt = "";
           var bidSokCnt = "";
...
function fn_list(){
	...
	window.location.href = "${pageContext.request.contextPath}/front/fixYAuc/fixBuySmallList.do?jCode="+jCode;
}
