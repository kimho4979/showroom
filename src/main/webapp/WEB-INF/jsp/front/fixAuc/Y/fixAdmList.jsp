...
function fn_view(fixDealSeq){
	window.location.href = "${pageContext.request.contextPath}/front/fixYAuc/fixAdmView.do?fixDealSeq="+fixDealSeq;
}
	...
	if(checkedArray.length == 0){
		...
		$.ajax({
	        ...
	        success : function(data){
	             ...
	             location.href = "${pageContext.request.contextPath}/front/fixYAuc/fixAdmList.do?history=true";
	             /* 정렬 유지 수정 1 (E) */
	        }
	    });
	}
						...
						<div class="info_box">
							...
							<div class="sub_tab">
								<ul class="devide_3">
									...
									<li><a href="${pageContext.request.contextPath}/front/fixYAuc/fixAdmList.do" class="active">&nbsp;&nbsp;&nbsp;난&nbsp;&nbsp;&nbsp;</a></li>
									</c:if>
							...
							<form id="frm" name="searchFrm" method="get" action="${pageContext.request.contextPath}/front/fixYAuc/fixAdmList.do" >
							<!-- 정렬 유지 수정 5 (E) -->
									...
									<tbody id="resultWebList">
										<c:forEach items="${resultList}" var="result" varStatus="status">
											<tr id="fixTr${result.fixDealSeq}">
												...
												<td class="tc" style="cursor:pointer" onclick="fn_view('${result.fixDealSeq}');"><p class="txt_01">${result.pumName}<c:if test="${result.twinCnt ne '0'}">/${result.twinCnt}</c:if></p></td>
