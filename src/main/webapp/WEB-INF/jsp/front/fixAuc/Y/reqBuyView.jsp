...
function fn_update(reqDealSeq){
	window.location.href = "${pageContext.request.contextPath}/front/fixYAuc/reqBuyUpt.do?reqDealSeq="+reqDealSeq;
}

function fn_delete(reqDealSeq){
	window.location.href = "${pageContext.request.contextPath}/front/fixYAuc/reqBuyDelProc.do?reqDealSeq="+reqDealSeq;
}
