...
function fn_view(fixDealSeq){
	...
	window.location.href = "${pageContext.request.contextPath}/front/fixYAuc/fixBuyView.do?fixDealSeq="+fixDealSeq+"&jCode="+jCode;
}

function fn_reg(){
	window.location.href = "${pageContext.request.contextPath}/front/fixYAuc/fixBuyReg.do";
}
...
function fn_more(){
	...
	$.ajax({
        ...
        type : "POST",
        url : "${pageContext.request.contextPath}/front/fixYAuc/fixBuyList.json",
...
function fn_bid(fixDealSeq, bidBoxCnt, bidSokCnt, bidUnitPrice ){
	...
	$.ajax({
        ...
        type : "POST",
        url : "${pageContext.request.contextPath}/front/fixYAuc/fixBuyBid.json",
        success : function(data){
           if(data.result == 1){
        	   alert("정상적으로 입찰되었습니다");
						...
						<div class="info_box">
							...
							<div class="sub_tab">
								<ul class="devide_3">
									...
									<li><a href="${pageContext.request.contextPath}/front/fixYAuc/fixBuyList.do" class="active">&nbsp;&nbsp;&nbsp;난&nbsp;&nbsp;&nbsp;</a></li>
									</c:if>
							...
							<!-- 검색조건창(S) -->
							<form id="frm" name="searchFrm" method="post" action="${pageContext.request.contextPath}/front/fixYAuc/fixBuyList.do" >
