				...
				<div class="info_box">
					...
					<div class="m_col_wrap">
						<div class="m_col_left">
							<!-- 테이블03(S) -->
							<form id="frm" name="frm" method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/front/fixYAuc/reqBuyUptProc.do" >
												...
												<td class="tl">
													<div class="sel_type_03 w50p">
														...
														<c:choose>
													        ...
													        <option value="${result.mokCode}" selected="selected">${result.mokName}(호접란)</option>
														    </c:when>
														    <c:when test="${result.mokCode eq '6043'}">
													        <option value="${result.mokCode}" selected="selected">${result.mokName}(팔레높시스)</option>
														    </c:when>
														    <c:otherwise>
