				...
				<div class="info_box">
					...
					<div class="m_col_wrap">
						<div class="m_col_left">
							<!-- 테이블03(S) -->
							<form id="frm" name="frm" method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/front/fixYAuc/fixSmallAdmUptProc.do" >
								...
								<div class="table_type_03">
									<table>
										...
										<tbody>
											...
											<tr>
												<th class="tc">상장번호</th>
												<td class="tl"><p class="txt_01">${result.upNo}</p></td>
											</tr>
											<tr>
												<th class="tc">이미지</th>
												<td class="tl">
											...
											<tr id="twinTr" <c:if test="${result.mokCode ne '1005'}">style="display: none;"</c:if>>
							...
							<div class="btn_box mt30">
								...
								<a href="${pageContext.request.contextPath}/front/fixYAuc/fixSmallAdmList.do" class="btn_type_01 list" id="listBtn">목록</a>
							</div>
						</div>
