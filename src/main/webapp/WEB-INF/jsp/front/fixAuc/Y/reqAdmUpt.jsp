				...
				<div class="info_box">
					...
					<div class="m_col_wrap">
						<div class="m_col_left">
							<!-- 테이블03(S) -->
							<form id="frm" name="frm" method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/front/fixYAuc/reqAdmUptProc.do" >
										...
										<tbody>
											...
											<tr>
												...
												<td class="tl">
													...
													<input type="hidden" id="jCode" name="jCode" value="${result.jCode}"/>
													<input type="text" id="jCodeName" name="jCodeName" value="${result.jName}" onkeydown="fn_enterJCode();"/>
													</div>
											...
											<tr>
												...
												<td class="tl">
													<div class="sel_type_03 w50p">
													<input type="hidden" id="chulCode" name="chulCode" value="${result.chulCode}"/>
													<input type="text" id="chulCodeName" name="chulCodeName" value="${result.chulName}" onkeydown="fn_enterChulCode();"/>
													</div>
											...
											<tr>
												...
												<td class="tl">
													<div class="sel_type_03 w50p">
													<input type="hidden" id="mokCode" name="mokCode" value="${result.mokCode}"/>
													<input type="hidden" id="mokName" name="mokName" value="${result.mokName}"/>
													<c:choose>
													    <c:when test="${result.mokCode eq '6002'}">
												        <input type="text" id="searchMokName" name="searchMokName" value="${result.mokName}(호접란)" onkeydown="fn_enterMokCode();"/>
													    </c:when>
													    <c:when test="${result.mokCode eq '6043'}">
												        <input type="text" id="searchMokName" name="searchMokName" value="${result.mokName}(팔레높시스)" onkeydown="fn_enterMokCode();"/>
													    </c:when>
													    <c:otherwise>
													    <input type="text" id="searchMokName" name="searchMokName" value="${result.mokName}" onkeydown="fn_enterMokCode();"/>
													    </c:otherwise>
													</c:choose>
													</div>
											...
											<tr>
												...
												<td class="tl">
													<div class="sel_type_03 w50p">
													<input type="hidden" id="pumCode" name="pumCode" value="${result.pumCode}"/>
													<input type="hidden" id="pumName" name="pumName" value="${fn:replace(result.pumName, '"', '&quot;')}"/>
													<input type="text" id="searchJongName" name="searchJongName" value="${fn:replace(result.pumName, '"', '&quot;')}" onkeydown="fn_enterJongCode();"/>
													</div>
											...
											<tr id="twinTr">
												...
												<td class="tl">
													...
													<div class="ip_type_01 w90">
														<input type="number" class="tr" id="stwinCnt" name="stwinCnt" maxlength="2" oninput="maxLengthCheck(this)" value="${fn:substring(result.twinCnt,0,2)}" onkeydown="fn_enterFocus('etwinCnt')">
														<label for="stwinCnt"></label>
													</div>
													-
													<div class="ip_type_01 w90">
														<input type="number" class="tr" id="etwinCnt" name="etwinCnt" maxlength="2" oninput="maxLengthCheck(this)" value="${fn:substring(result.twinCnt,3,5)}" onkeydown="fn_enterFocus('chulLevel')">
											...
											<tr>
												...
												<td class="tl">
													<div class="ip_type_01 w100">
														<input type="number" class="tr" id="boxCnt" name="boxCnt" value="${result.boxCnt}" maxlength="2" oninput="maxLengthCheck(this)" onkeydown="fn_enterFocus('sokCnt')">
											...
											<tr>
												...
												<td class="tl">
													<div class="ip_type_01 w100">
														<input type="number" class="tr" id="sokCnt" name="sokCnt" value="${result.sokCnt}" maxlength="4" oninput="maxLengthCheck(this)" onkeydown="fn_enterFocus('unitPrice')">
											...
											<tr>
												...
												<td class="tl">
													<div class="ip_type_01 w100">
														<input type="number" class="tr" id="unitPrice" name="unitPrice" value="${result.unitPrice}" maxlength="10" oninput="maxLengthCheck(this)" onkeydown="fn_enterFocus('chulDate')">
											...
											<tr>
												...
												<td class="tl">
													<div class="date_box">
														<input type="text" class="datepicker" id="chulDate" name="chulDate" value="${result.chulDate}" onkeydown="fn_enterFocus('reqText')">
													</div>
												</td>
											</tr>
											<tr>
												...
												<td class="tl">
													<div class="sb_data ml10">
														<label class="radio mr10">
															<input type="radio" name="panType" value="03" <c:if test="${result.panType eq '03'}">checked="checked"</c:if>>
															<i class="rdo"></i>
															<em class="label-title">선취</em>
														</label>
														<label class="radio mr10">
															<input type="radio" name="panType" value="04" <c:if test="${result.panType eq '04' || result.panType eq null}">checked="checked"</c:if>>
															<i class="rdo"></i>
...
function getJList(){
	...
	$.ajax({
        ...
        type : "POST",
        url : "${pageContext.request.contextPath}/front/fixYAuc/getJList.json",
        success : function(data){
...
function getEnterMokList(){
	...
	if(searchMokName.indexOf('(') > 0){
		searchMokName = searchMokName.substring(0, searchMokName.indexOf('('));	
	}
	...
	$.ajax({
        ...
        type : "POST",
        url : "${pageContext.request.contextPath}/front/fixYAuc/moklist.json",
        success : function(data){
           ...
           if(resultList.length > 1){
        	   for(var i=0; i<resultList.length; i++ ){
	       	   		if(resultList[i].id == "6002"){
						resultList[i].text = "팔레높시스(호접란)";
					}else if (resultList[i].id == "6043") {
						resultList[i].text = "호접란(팔레높시스)";	 
					}
        	   ...
        	   $("#searchMokCode").focus();
				...
				if(resultList[0].id == "6002"){
					resultList[0].text = "팔레높시스(호접란)";
				}else if (resultList[0].id == "6043") {
					resultList[0].text = "호접란(팔레높시스)";	 
				}
...
function getEnterJongList(){
	...
	$.ajax({
        ...
        type : "POST",
        url : "${pageContext.request.contextPath}/front/fixYAuc/pumlist.json",
        success : function(data){
           ...
           if(resultList.length > 1){
        	   for(var i=0; i<resultList.length; i++ ){
					if(resultList[i].pMokCode == "6002"){
						resultList[i].pMokName = "팔레높시스(호접란)";
					}else if (resultList[i].pMokCode == "6043") {
        	   ...
        	   if(resultList[0].pMokCode == "6002"){
					resultList[0].pMokName = "팔레높시스(호접란)";
				}else if (resultList[0].pMokCode == "6043") {
					resultList[0].pMokName = "호접란(팔레높시스)";	 
				}
...
function fn_jongClick(mokCode, mokName, pumCode, pumName){
	 ...
	 if(mokCode == "6002"){
		 $("#searchMokName").val("팔레높시스(호접란)");
	 }else if (mokCode == "6043") {
		 $("#searchMokName").val("호접란(팔레높시스)");	 
	 }
