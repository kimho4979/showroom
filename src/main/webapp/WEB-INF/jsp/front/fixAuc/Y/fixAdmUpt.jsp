				...
				<div class="info_box">
					...
					<div class="m_col_wrap">
						<div class="m_col_left">
							<!-- 테이블03(S) -->
							<form id="frm" name="frm" method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/front/fixYAuc/fixAdmUptProc.do" >
									...
									<table>
										...
										<tbody>
											...
											<tr>
												...
												<td class="tl">
													<div class="sel_type_03 w50p">
														<input type="text" class="tl" id="chulLevelCustom" name="chulLevelCustom" maxlength="50" value="${result.chulLevelName}" onkeydown="fn_enterFocus('boxCnt')">
											...
											<tr>
												...
												<td class="tl">
													<div class="date_box">
														<input type="text" class="datepicker" id="chulDate" name="chulDate" value="${result.chulDate}" onkeydown="fn_enterFocus('itemText')">
													</div>
												</td>
											</tr>
										</tbody>
							...
							<div class="btn_box mt30">
								...
								<a href="${pageContext.request.contextPath}/front/fixYAuc/fixAdmList.do" class="btn_type_01 list" id="listBtn">목록</a>
							</div>
						</div>
...
function getRecentList(){
	...
	if(chulCode == null || chulCode == "" ){
		...
		$.ajax({
	        ...
	        type : "POST",
	        url : "${pageContext.request.contextPath}/front/fixYAuc/getRecentList.json",
	        success : function(data){
