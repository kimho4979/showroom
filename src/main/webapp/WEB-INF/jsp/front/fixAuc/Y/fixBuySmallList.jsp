...
function fn_view(fixDealSeq){
	...
	window.location.href = "${pageContext.request.contextPath}/front/fixYAuc/fixBuySmallView.do?fixDealSeq="+fixDealSeq+"&jCode="+jCode;
}

/* function fn_reg(){
	window.location.href = "${pageContext.request.contextPath}/front/fixYAuc/fixBuySmallReg.do";
} */
...
function fn_more(){
	...
	$.ajax({
        ...
        type : "POST",
        url : "${pageContext.request.contextPath}/front/fixYAuc/fixBuySmallList.json",
...
function fn_bid(fixDealSeq, bidBoxCnt, bidSokCnt, bidUnitPrice ){
	...
	$.ajax({
        ...
        type : "POST",
        url : "${pageContext.request.contextPath}/front/fixYAuc/fixBuySmallBid.json",
        success : function(data){
           if(data.result == 1){
        	   alert("정상적으로 입찰되었습니다");
						...
						<div class="info_box">
							...
							<div class="sub_tab">
								<ul class="devide_3">
									...
									<li><a href="${pageContext.request.contextPath}/front/fixYAuc/fixBuySmallList.do" class="active">난</a></li>
									</c:if>
									<%-- <c:if test="${yFloLoginVO ne null }">
									<li><a href="${pageContext.request.contextPath}/front/fixYAuc/fixBuySmallList.do">&nbsp;&nbsp;&nbsp;난&nbsp;&nbsp;&nbsp;</a></li>
									</c:if>
									<c:if test="${yFloLoginVO ne null }">
									<li><a href="${pageContext.request.contextPath}/front/fixYAuc/fixBuySmallList.do">관엽</a></li>
									<li><a href="${pageContext.request.contextPath}/front/fixYAuc/fixBuySmallSubList.do">관엽-분갈이</a></li>
									</c:if> --%>
								</ul>
							</div>
							<!-- 서브탭(E) -->
							...
							<!-- 검색조건창(S) -->
							<form id="frm" name="searchFrm" method="post" action="${pageContext.request.contextPath}/front/fixYAuc/fixBuySmallList.do" >
