...
function getBidBuyInfo(fixDealSeq){
	...
	$.ajax({
        ...
        type : "POST",
        url : "${pageContext.request.contextPath}/front/fixYAuc/getBidBuyInfo.json",
        success : function(data){
           console.log(data);
           var bidBoxCnt = "";
           var bidSokCnt = "";
...
function fn_list(){
	...
	window.location.href = "${pageContext.request.contextPath}/front/fixYAuc/fixBuyList.do?jCode="+jCode;
}
