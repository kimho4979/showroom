...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$('#contentList').DataTable({
			...
			ajax: {
				type : "POST",
				url : "${pageContext.request.contextPath}/admin/boardInfo/boardInfoList.json",
				dataType: "JSON",
				data: function(d){
			...
			columns : [
			    {data: "boardId"			,className: "cursor-link"	,render: $.fn.dataTable.render.text()},        
				{data: "boardNm"		,className: "cursor-link"	,render: $.fn.dataTable.render.text()},
				{data: "boardTy"		,className: "cursor-link"	,render: $.fn.dataTable.render.text()},
	...
	function contentManageCreate(){
		...
		window.location.href = "${pageContext.request.contextPath}/admin/boardInfo/create.do";
	}
	...
	function contentDetail(data){
		...
		window.location.href = "${pageContext.request.contextPath}/admin/boardInfo/update.do?boardId="+data;
