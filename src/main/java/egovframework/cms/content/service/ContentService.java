...
public interface ContentService {
	...
	List<ContentVO> getContentList(Map<String, Object> paramMap) throws Exception;

	int getContentListCnt(Map<String, Object> paramMap) throws Exception;

	ContentVO getContent(Map<String, Object> paramMap) throws Exception;
