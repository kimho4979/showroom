...
@Service("frontFixNAucSmallService")
public class FrontFixNAucSmallServiceImpl extends EgovAbstractServiceImpl implements FrontFixNAucSmallService{
	
	private static final Logger LOGGER = LoggerFactory.getLogger(FrontFixNAucSmallServiceImpl.class);
	
	@Resource(name = "frontFixNAucSmallMapper")
	private FrontFixNAucSmallMapper frontFixNAucSmallMapper;
