...
@Controller
public class FrontFixYSmallJAucController {
	private static final Logger logger = LoggerFactory.getLogger(FrontFixYSmallJAucController.class);

	@Resource(name = "frontLoginService")
	protected FrontLoginService frontLoginService;
	
	@Resource(name = "FrontFixYAucSmallJService")
	private FrontFixYAucSmallJService frontfixCAucSmallJService;
	...
	@RequestMapping(value="/front/fixYAuc/fixBuySmallList.do")
	public String fixBuySmallList2(HttpServletRequest request, HttpServletResponse response,
		...
		model.addAttribute("contentPath", "fixAuc/Y/fixBuySmallList.jsp");
	...
	@RequestMapping(value="/front/fixYAuc/fixBuySmallList.json")
	...
	@RequestMapping(value="/front/fixYAuc/fixBuySmallView.do")
	public String fixBuySmallView(HttpServletRequest request, HttpServletResponse response,
		...
		model.addAttribute("contentPath", "fixAuc/Y/fixBuySmallView.jsp");
	...
	@RequestMapping(value = "/front/fixYAuc/fixBuySmallBid.json")
	...
	@RequestMapping(value = "/front/fixYAuc/getSmallBidBuyInfo.json")
	...
	@RequestMapping(value="/front/fixYAuc/fixSmallListExcell.do")
