...
@Service("FrontFixYAucSmallService")
public class FrontFixYAucSmallServiceImpl extends EgovAbstractServiceImpl implements FrontFixYAucSmallService{
	
	private static final Logger LOGGER = LoggerFactory.getLogger(FrontFixYAucSmallServiceImpl.class);
	
	@Resource(name = "FrontFixYAucSmallMapper")
	private FrontFixYAucSmallMapper frontFixNAucSmallMapper;
